export class AppSettings {
  ...
  public static API_ENDPOINT_REPORT_SERVICE = AppSettings.API_ENDPOINT +"/report";
  ...
  public static API_ENDPOINT_CLIENT_DASHBOARD = AppSettings.API_ENDPOINT_REPORT_SERVICE  + "/dashboard";
  ...
  public static API_ENDPOINT_CLIENT_FUNNEL = AppSettings.API_ENDPOINT_REPORT_SERVICE + "/report/funnel/funnel";

  // public static API_ENDPOINT_CLIENT_REPORT_SEGMENT = AppSettings.API_ENDPOINT_CLIENT + "/report/segment";
  public static API_ENDPOINT_CLIENT_REPORT_SEGMENT = AppSettings.API_ENDPOINT_REPORT_SERVICE + "/report/segment";
  ...
  public static API_ENDPOINT_CLIENT_REPORT_CAMPAIGN = AppSettings.API_ENDPOINT_REPORT_SERVICE  + "/report/campaign";
