export class AppSettings {
  ...
  public static API_ENDPOINT_CLIENT_CLIENT_NOTIFICATION = AppSettings.API_ENDPOINT_CLIENT_CLIENT + "/notification";
  public static API_ENDPOINT_CLIENT_CLIENT_NOTIFICATION_TEMPLATES = AppSettings.API_ENDPOINT_CLIENT_CLIENT_NOTIFICATION + "/templates";
  public static API_ENDPOINT_CLIENT_CLIENT_SMS_NOTIFICATION_TEMPLATES = AppSettings.API_ENDPOINT_CLIENT_CLIENT_NOTIFICATION + "/save-template";
